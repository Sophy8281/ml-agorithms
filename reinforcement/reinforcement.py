...
for episode in range(1000):
    ...
    for step in range(1000):  # 1000 total steps, don't want to run forever
        action = basic_policy(obs)  # perform an action based on the policy and observed env
        env.render()
...
print(totals)
print('The longest number of time steps the pole was balanced: ' + str(max(totals)))
